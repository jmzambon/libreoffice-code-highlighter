CH2_STRINGS = {"en": { # dialog controls (label text + help text)
                      "label_lang": ("Language", ""),
                      "label_style": ("Style", ""),
                      "check_charstyles": ("Use character ~styles in Writer", "When possible, code highlighting will be based on character styles."),
               ...
               "fr": { # contrôles de dilaogue (texte + texte d'aide)
                      "label_lang": ("Langage", ""),
                      "label_style": ("Style", ""),
                      "check_charstyles": ("Utiliser les ~styles de caractère dans Writer", "Si possible, le code sera colorisé sur base des styles de caractère."),
                      ...
                      "lbl_nb_pad": ("Symbole de retrait", "Caractère initial de substitution (0 pour 01 par exemple)"),
