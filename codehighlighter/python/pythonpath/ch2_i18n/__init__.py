CH2_STRINGS = {
    "en": {  # dialog controls (label text + help text)
        "label_lang": ("Language", ""),
        "label_style": ("Style", ""),
        "check_charstyles": (
            "Use character ~styles",
            "When possible, code highlighting will be based on character styles.",
        ),
        "check_col_bg": (
            "Set ~background color",
            "Use the background color provided by the style.",
        ),
        ...
        "lbl_nb_pad": (
            "Padding symbol",
            "Character to fill the leading space (0 for 01 for example)",
        ),
        "lbl_cs_rootstyle": (
            "Parent character style",
            "Use an existing character style as root style.",
        ),
        "nb_sep": ("", ""),
    ...
    "fr": {  # contrôles de dilaogue (texte + texte d'aide)
        ...
        "label_style": ("Style", ""),
        "check_charstyles": (
            "Utiliser les ~styles de caractère",
            "Si possible, le code sera colorisé sur base des styles de caractère.",
        ),
        "check_col_bg": (
            "Utiliser la couleur de ~fond",
            "Utiliser l'arrière-plan fourni par le style.",
        ),
        "check_linenb": (
            "Numéroter les ~lignes",
            "Affiche ou masque les numéros de ligne.",
        ),
        ...
        "lbl_nb_pad": (
            ...
            "Caractère initial de substitution (0 pour 01 par exemple)",
        ),
        "lbl_cs_rootstyle": (
            "Style de caractère parent",
            "Utiliser un style de caractère existant comme style de base.",
        ),
        "nb_sep": ("", ""),
