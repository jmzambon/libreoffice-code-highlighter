CH2_STRINGS = {"en": { # dialog controls (label text + help text)
                      ...
                      "lbl_masterstyle": ("Parent character style:", "Use an existing character style as root style."),
                      "nb_sep": ("", ""),
               ...
               "fr": { # contrôles de dilaogue (texte + texte d'aide)
                      ...
                      "lbl_masterstyle": ("Style de caractère parent :", "Utiliser un style de caractère existant comme style de base."),
                      "nb_sep": ("", ""),
